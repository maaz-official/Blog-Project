...
import { useCreatePostMutation } from '../../../../slices/postApiSlice'; // Import the create post mutation
...
const CreatePost = () => {
  ...
  const [createPost, { isLoading }] = useCreatePostMutation(); // Initialize the createPost mutation
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={6}>
              <Button
                ...
                disabled={isLoading} // Disable while loading
              >
                {isLoading ? 'Creating...' : 'Create Post'} {/* Show loading status */}
              </Button>
            </Grid>
          </Grid>
        </form>
