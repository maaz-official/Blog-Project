const Post = [
  ...
  },
  {
    ...
    author: {
      id: "456",
      name: "Emily Clark",
      profilePicture: "/assets/profile/emily.jpg",
    },
    content:
      "JavaScript has come a long way, and with ES6+ updates, developers have powerful new tools like arrow functions, destructuring, and async/await to enhance their coding efficiency and readability...",
    coverImage: "/assets/js-es6.jpg",
    ...
    comments: [
      {
        ...
        author: {
          id: "789",
          name: "Mark Lee",
          profilePicture: "/assets/profile/mark.jpg",
        },
        content: "This is exactly what I needed! The explanation of async/await was spot on.",
        createdAt: "2023-09-18T14:15:30Z",
        likes: 15,
        replies: [
          {
            id: "r1",
            author: {
              id: "101",
              name: "Sophia Evans",
              profilePicture: "/assets/profile/sophia.jpg",
            },
            content: "I agree! Async/await can really simplify complex asynchronous code.",
            createdAt: "2023-09-18T16:42:18Z",
          },
          {
            id: "r2",
            author: {
              id: "102",
              name: "John Doe",
              profilePicture: "/assets/profile/john.jpg",
            },
            content: "I was confused about promises before, but this article made it so much clearer.",
            createdAt: "2023-09-18T17:00:00Z",
          },
        ],
      },
      {
        ...
        author: {
          id: "456",
          name: "Daniel Green",
          profilePicture: "/assets/profile/daniel.jpg",
        },
        content: "Great read! I think more examples of destructuring in real-world scenarios would be helpful.",
        createdAt: "2023-09-19T10:10:00Z",
        likes: 8,
        replies: [
          {
            id: "r3",
            ...
            content: "Thanks for the feedback, Daniel! I’ll make sure to include more real-world examples in future posts.",
    ...
    updatedAt: "2023-09-19T09:45:00Z",
  },  
  {
    id: "3",
